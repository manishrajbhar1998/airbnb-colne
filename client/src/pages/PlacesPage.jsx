          ...
          <div>
            <form>
              ...
              <div className='flex gap-2'>
                ...
                <button className='px-4 rounded-2xl' onClick={addPhotoByLink}>Add&nbsp;photo</button>
              </div>
              <div className='mt-4 grid grid-cols-3 md:gridcols-4 lg:grid-col-6'>
                <button className='flex gap-1 justify-center rounded-2xl border bg-transparent p-3 text-xl'>
              ...
              <p className='text-gray-400 text-sm mb-1'>Description of the place</p>
              <textarea></textarea>
              <p className='text-2xl mt-4'>Perks</p>
              <p className='text-gray-500 text-sm mb-1'>Select all the perks of your place</p>
              <div className='grid mt-2 gap-4 grid-cols-2 md:grid-cols-3 ls:grid-cols-6'>
              ...
              <p className='text-2xl mt-4'>Extra Info</p>
              <p className='text-gray-500 text-sm mb-1'>House rules, etc</p>
              <textarea></textarea>
              <p className='text-2xl mt-4'>Check In&Out times, max guests</p>
              <p className='text-gray-500 text-sm mb-1'>add check in and out times, remember to have some time window for cleaning the room</p>
